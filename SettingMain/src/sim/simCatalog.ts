...
export const SIM_CATALOG: readonly SimMethod[] = [
  ...
  { method: 'cam.savePreset', title: '카메라 프리셋 저장', mutating: true, movesCamera: false },
  { method: 'cam.loadPreset', title: '카메라 프리셋 열기', mutating: true, movesCamera: false },
  { method: 'cam.applyPreset', title: '카메라 프리셋 적용', mutating: true, movesCamera: true },
  ...
  { method: 'preset.setBoxVisible', title: '3D 육면체 표시', mutating: true, movesCamera: false },
  ...
  { method: 'car.setMetallic', title: '차량 재질', mutating: true, movesCamera: false },
  ...
  // --- random / 차량 랜덤 배치 -----------------------------------------------
  { method: 'random.randomizeAll', title: '전체 랜덤화', mutating: true, movesCamera: false },
  { method: 'random.recreateCars', title: '차량 재생성', mutating: true, movesCamera: false },
  { method: 'random.slotJitter', title: '주차 위치 흔들기', mutating: true, movesCamera: false },
  { method: 'random.frontBack', title: '전/후면 주차 랜덤', mutating: true, movesCamera: false },
